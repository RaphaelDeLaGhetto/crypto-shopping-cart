...
describe('index', () => {
  ...
  describe('when database is empty', () => {
    ...
    it('displays footer information', () => {
      ...
      browser.assert.element('footer#info span:nth-child(2) a[href="https://github.com/RaphaelDelaGhetto/interac-e-transfer-shopping-cart"]');
  ...
  describe('when database contains products', () => {
    ...
    it('structures the product list with what\'s in the database', (done) => {
      models.Product.find({}).sort('createdAt').then((results) => {
        ...
        browser.assert.text('ul#products li.product:nth-child(2) .cart-data .product-info span.price', `${results[1].formattedPrice}`);
